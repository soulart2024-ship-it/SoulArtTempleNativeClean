...
struct DiscoveryCategoryView: View {
    ...
    @State private var calibratedFrequency: Int? = nil

    @EnvironmentObject var store: DiscoveryStore
    @EnvironmentObject var appState: AppState

    private let allCategories = [
        "Common", "Ancestral", "Heart Shadows", "Etheric",
        "Aura / Field", "DNA", "Third Trimester", "Twin (Dual)",
        "Deeply Hidden", "Stealth", "Body Coded", "Unidentified"
    ]
    ...
    var body: some View {
        ...
        ZStack {
            ...
            ScrollView {
                ...
                VStack(spacing: Theme.spacingLarge) {
                    ...
                    // ⚡ FREQUENCY CALIBRATION BUTTON — ONE ONLY
                    Button {
                        ...
                        HStack(spacing: 10) {
                            ...
                            VStack(alignment: .leading, spacing: 2) {
                                Text(calibratedFrequency == nil ? "Calibrate Your Frequency" : "Frequency: \(calibratedFrequency!) — Recalibrate")
                                    .font(Theme.smallText.weight(.medium))
                                    .foregroundStyle(Theme.textPrimary)
                                Text(calibratedFrequency == nil ? "Optional — discover where your energy is today" : hawkinsName(for: calibratedFrequency!))
                                    .font(.caption)
                                    .foregroundStyle(Theme.textSecondary.opacity(0.6))
                            }
                            Spacer()
        ...
        .sheet(isPresented: $showCalibration) {
            FrequencyCalibrationView { frequency in
        ...
        ZStack {
            ...
            ZStack {
                ...
                Image("still_art")
                    ...
                    .animation(.easeInOut(duration: 0.4), value: revealedCategory)
    ...
    func hawkinsName(for frequency: Int) -> String {
        switch frequency {
        case 0..<50: return "Shame"
        case 50..<75: return "Guilt"
        case 75..<100: return "Apathy"
        case 100..<125: return "Grief"
        case 125..<175: return "Fear"
        case 175..<200: return "Desire"
        case 200..<250: return "Anger"
        case 250..<310: return "Pride"
        case 310..<350: return "Courage"
        case 350..<400: return "Neutrality"
        case 400..<450: return "Willingness"
        case 450..<500: return "Acceptance"
        case 500..<540: return "Love"
        case 540..<600: return "Joy"
