...
struct Theme {
    ...
    static let textOnButton = warmParchment
    static let textOnParchment = deepBrown
...
extension Theme {
    ...
    enum LogoSize {
        ...
        case medium     // 60x60 - for headers
        case large      // 100x100 - for hero sections
    ...
    // Main logo view - reusable across all views
    static func logo(size: LogoSize = .medium) -> some View {
    ...
    // Logo with optional custom size
    static func logo(width: CGFloat, height: CGFloat) -> some View {
        Image("SoulArt Brand full")
            .resizable()
            .scaledToFit()
...
extension Theme {
    ...
    static let success = Theme.deepBrown
