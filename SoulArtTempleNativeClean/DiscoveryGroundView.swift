            ...
            ZStack {
                ...
                VStack(spacing: 30) {
                    ...
                    Button {
                        ...
                        if sessionCounter.canStartNewSession() {
                            // 🌿 BEGIN TRANSITION
                            ...
                            DispatchQueue.main.asyncAfter(deadline: .now() + 0.45) {
                                ...
                                UserDefaults.standard.set(true, forKey: "isDiscoveryFlow")  // 👈 ADD THIS LINE
                        ...
                        VStack(spacing: 4) {
                            ...
                            // Show remaining sessions if not unlimited
                            if !PurchaseManager.shared.hasUnlockedFullAccess {
                                Text("\(sessionCounter.remainingSessions()) of 3 free sessions remaining")
                                    .font(.system(size: 12))
